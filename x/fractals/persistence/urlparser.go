...
func ConfigToFractalURL(config Config, autopilot, dynamicColor bool, transitionMode int) string {
	...
	// Color theme
	if config.ColorScheme != "" && config.ColorScheme != colorthemes.ColorGrayscale {
...
func RandomToFractalURL(colorTheme string, autopilot, dynamicColor bool, transitionMode int) string {
	...
	if colorTheme != "" && colorTheme != colorthemes.ColorGrayscale {
...
func IsValidColorTheme(theme string) bool {
	validThemes := map[string]bool{
		...
		colorthemes.ColorRainbow:   true,
		colorthemes.ColorFire:      true,
		colorthemes.ColorPurple:    true,
		colorthemes.ColorGreen:     true,
		colorthemes.ColorGold:      true,
		colorthemes.ColorCyan:      true,
	}
