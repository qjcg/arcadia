---
description: The official Gherkin specification reference — keywords, step definitions, scenario outlines, doc strings, data tables, and spoken languages.
source: https://cucumber.io/docs/gherkin/reference
source_raw: https://raw.githubusercontent.com/cucumber/website/9bca7375458301f81aaa2f7857587dd141688fab/docs/gherkin/reference.md
---
...
> **Tool support for backticks:** Whilst all current versions of Cucumber support backticks as the delimiter, many tools like text editors don't (yet).
...
> **Tool support for content types:** Whilst all current versions of Cucumber support content types as the delimiter, many tools like text editors don't (yet).
